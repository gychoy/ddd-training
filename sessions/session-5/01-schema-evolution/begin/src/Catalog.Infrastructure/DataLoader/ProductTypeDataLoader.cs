...
{
    public IProductTypesDataLoader ProductTypes =>
        services.GetRequiredService<IProductTypesDataLoader>();

    public IProductTypeByIdDataLoader ProductTypeById =>
        services.GetRequiredService<IProductTypeByIdDataLoader>();

    public IProductTypeByNameDataLoader ProductTypeByName =>
        services.GetRequiredService<IProductTypeByNameDataLoader>();
}
...
internal static class ProductTypeDataLoader
{
    ...
    public static Task<Dictionary<int, ProductTypeDto>> GetProductTypeByIdAsync(
        ...
        => context.ProductTypes
            ...
            {
                Id = x.Id, Name = x.Name, TotalProducts = x.TotalProducts
            })
